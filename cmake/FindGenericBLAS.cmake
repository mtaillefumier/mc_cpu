...
if(GenericBLAS_FOUND)
  ...
  if(NOT TARGET mc_cpu::BLAS::GenericBLAS::blas)
    add_library(mc_cpu::BLAS::GenericBLAS::blas INTERFACE IMPORTED)
  endif()
  set_property(TARGET mc_cpu::BLAS::GenericBLAS::blas
               PROPERTY INTERFACE_LINK_LIBRARIES ${GenericBLAS_LIBRARIES})
  set_property(
    TARGET mc_cpu::BLAS::GenericBLAS::blas PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                                                  ${GenericBLAS_INCLUDE_DIRS})
endif()
